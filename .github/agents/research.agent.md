...
Do not invoke separate stage agents for `01`–`102`. All stage logic lives in the skills listed above, and this single agent owns all reads, searches, edits, validation, and final reporting.
