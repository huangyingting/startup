...
1. Read `./references/report-schema-v2.md`, `./references/yaml-rules.md`, and `./references/chapter-packet-schema-v2.md` (the schema for the JSON the chapter loader emits).
