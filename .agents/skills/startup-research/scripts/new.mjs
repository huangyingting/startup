...
function usage() {
  console.error('Usage: node .agents/skills/startup-research/scripts/new.mjs <YYYYMMDDHHmmss> <company name> [--website <url>] [--allow-duplicate] [--index reports/_index.yaml]');
  process.exit(1);
}
